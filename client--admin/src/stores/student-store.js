  ...
  getters: {
    getThisYearLabels: (state) => {
      return state.queriedStudent.data.stats.thisYear
        .filter(violation => violation.violationIsMajor === state.settingStore.displayMajor)
    ...
    getThisYearViolations: state => { return state.queriedStudent.data.stats.thisYear },
    ...
    getLastYearViolations: state => { return state.queriedStudent.data.stats.lastYear },
    ...
    getAllTimeViolations: state => { return state.queriedStudent.data.stats.allTime },
  },
  actions: {
