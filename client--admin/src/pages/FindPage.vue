      ...
      <div class="page--find__main">
        <div class="page--find__data">
          <template v-if="studentStore.queriedStudent">
            ...
            <div class="page--find__data--student" v-else-if="studentStore.queriedStudent.hasMultipleStudents === false">
              <div class="page--find__data--student-header">
                <div class="page--find__data--student-name-id">{{ `${studentStore.queriedStudent.data[0].studentLastName}, ${studentStore.queriedStudent.data[0].studentFirstName} (${studentStore.queriedStudent.data[0].studentId})`}}</div>
                <div class="page--find__data--student-course-year">{{ `${studentStore.queriedStudent.data[0].studentCourse} - ${studentStore.queriedStudent.data[0].studentYear} year`}}</div>
              </div>
            <violation-table 
              class="page--find__data--student-table" 
              :violations="studentStore.queriedStudent.data" 
              :showMajor=false
              title="Violation"
            />
            </div>
