<template>
  <div
    ...
    :class="{ 'input--search__container--active': inputActive }"
  >
    <div class="input--search__icon" v-html="searchIconSvg" />
    <input
      class="input--search__input"
      :class="{ 'input--search__input--active': inputValue }"
      type="search"
      ref="inputSearch"
...
.input--search {
  &__container {
    ...
    box-shadow: 0 0.4rem 1.6rem rgba($primary-1, 0.16);
    transition: box-shadow 400ms ease;

    &--active {
      box-shadow: 0 0 0 rgba($primary-1, 0.16);
    }
